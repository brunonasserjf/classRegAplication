...
function AdminScreen({navigation}) {
  ...
  async function getAllData() {
    //axios.get('http://192.168.100.32:5002/get-all-user').then(res => {
    axios.get('https://classregserver.onrender.com/get-all-user').then(res => {
  ...
  async function getData() {
    ...
    axios
      ...
      .post('http://https://classregserver.onrender.com/userdata', {token: token})
      .then(res => {
        console.log(res.data);
  ...
  function deleteUser(data) {
    axios
      //.post('http://192.168.100.32:5002/delete-user', {id: data._id})
      .post('https://classregserver.onrender.comdelete-user', {id: data._id})
      .then(res => {
        console.log(res.data);
