import { StyleSheet, Text, View, Button, ScrollView, TouchableOpacity, Image, BackHandler, Alert } from 'react-native';
        ...
        <View>
            ...
            <View style={styles.infoMain}>
                ...
                <View style={styles.infoText}>
                    <Text style={styles.infoSmall_Text}>E-mail</Text>
            ...
            <View style={styles.infoMain}>
                ...
                <View style={[styles.infoIconCont, {backgroundColor: '#f2276e'}]}>
                    <Email name="calendar" size={24} style={{color: 'white'}} />
                </View>
                <View style={styles.infoText}>
                    <Text style={styles.infoSmall_Text}>Data de nascimento</Text>
                    <Text style={styles.infoLarge_Text}>{generateTitle(userData.birth)}</Text>
                </View>
                </View>
            </View>
            ...
            <View style={styles.infoMain}>
                ...
                <View style={[styles.infoIconCont, {backgroundColor: '#774BBC'}]}>
                    <Email name="certificate" size={24} style={{color: 'white'}} />
                </View>
                <View style={styles.infoText}>
                    <Text style={styles.infoSmall_Text}>Profissão</Text>
